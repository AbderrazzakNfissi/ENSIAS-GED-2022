...
Route::post('/partagerDocument',[PartageController::class,'partagerDocument']);
...
Route::get('/telecharger/{id}',[PartageController::class,'telecharger']);

//Route::get('/liste/{user_id}',[EntrepriseController::class,'supprimerUser'])->name('listeUsers');

Route::get('/DeleteUser/{user_id}',[EntrepriseController::class,'deleteUser']);
...
Route::get('/messages',[PartageController::class,'messages']);


Route::get('/MessageVu',[PartageController::class,'messageVu']);


Route::get('/logoutTimestamp',[UserController::class,'logoutTimestamp']);


Route::get('/Deplacer',[DocumentController::class,'deplacer']);
