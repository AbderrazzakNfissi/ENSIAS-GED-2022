...
function drop(ev) {
  ev.preventDefault();
  var document_id = ev.dataTransfer.getData("text");
  var dct = document.getElementById(document_id);
  dct.style.display = "none";
  ev.target.appendChild(dct);
  var data_to_send = document_id+':'+idFolder;
  $(document).ready(function(){
