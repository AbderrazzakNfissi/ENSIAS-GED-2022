...
<div class="card text-center" style="width: 77%;border-bottom:0px!important;">
  <div class="card-header nombre-elements"  style="text-align: center;">
   ...
   <a href="/compte" style="text-decoration: none;color: #002222!important;"><strong>
    ...
    @if(isset($section))
    <a href="/sections/{{ $section->id }}" style="text-decoration: none;color: #002222!important;"> <strong> {{$section->nom}} </strong></a>
    @endif
    @isset($folder)
    <a href="/sections/{{ $section->id }}/{{$dossier_id}}" style="text-decoration: none;color: #002222!important;"> <strong>/ {{$folder->nom}} </strong></a>
    @endisset
  ...
  <div class="card-body search-list">
    @isset($dossiers)
    @isset($documents)
    @if(count($documents)>0 || count($dossiers)>0)
    <table class="table w3-animate-bottom" >
     
      <thead style="border-top : 0px;margin-bottom:50px ">
        <tr>
         
          
          <th scope="col" style="text-align: left;border :0px;border-left:1px solid rgb(184, 180, 180);margin-bottom:100px;" >Nom</th>
          <th scope="col" style="text-align: left;border :0px;border-left:1px solid rgb(184, 180, 180);margin-bottom:100px;">Type</th>
          <th scope="col" style="text-align: left;border :0px;border-left:1px solid rgb(184, 180, 180);margin-bottom:100px;">Taille</th>
          <th scope="col" style="border :0px;border-left:1px solid rgb(184, 180, 180);margin-bottom:100px;">action</th>
        </tr>
      </thead>
      <tbody>
       ...
       <!--------------------------Affichage des dossiers ------------------------->
              ...
              @isset($section)
              <tr class="w3-animate-bottom glisse{{$dossier->id}}" id="f_{{$dossier->id}}" name="{{$dossier->id}}"  ondrop="drop(event)" ondragover="allowDrop(event,{{$dossier->id}})">
                 <!------------------ Nom du dossier --------------------->
                ...
                <td style="text-align: left;border :0px;border :0px">
                  <a href="/sections/{{$section->id}}/{{$dossier->id}}" style="text-decoration: none">
               
               @isset($taille)
               @isset($i)
                @if($taille[$i]>1048576)
                 {{round($taille[$i++]/(1048576),2)}} Go
                 @elseif($taille[$i]>1024)
                 {{round($taille[$i++]/(1024),2)}} Mo
                 @else
                 {{round($taille[$i++],2)}} Ko
                 @endif
               @endisset
       ...
       <!------------------------ Affichage des documents--------------------------->
        ...
        <tr class="w3-animate-bottom" id="{{$doc->id}}" draggable="true" ondragstart="drag(event)">
          ...
          <td style="text-align: left;border:0px;" >
            ...
            <!-------------------word icon -------------------->
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-file-earmark-word-fill" viewBox="0 0 16 16">
            ...
            <!------------------------ HTML icon  -------------------->
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-filetype-html" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M14 4.5V11h-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5L14 4.5Zm-9.736 7.35v3.999h-.791v-1.714H1.79v1.714H1V11.85h.791v1.626h1.682V11.85h.79Zm2.251.662v3.337h-.794v-3.337H4.588v-.662h3.064v.662H6.515Zm2.176 3.337v-2.66h.038l.952 2.159h.516l.946-2.16h.038v2.661h.715V11.85h-.8l-1.14 2.596H9.93L8.79 11.85h-.805v3.999h.706Zm4.71-.674h1.696v.674H12.61V11.85h.79v3.325Z"/>
            </svg>
            <!-------------------------------------------------------->
            @elseif($doc->type=="Fichier image")
             <!------------------------ image icon  -------------------->
             <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-file-earmark-image" viewBox="0 0 16 16">
            ...
            @elseif($doc->type=="Fichier PowerPoint")
             <!------------------------ ppt icon  -------------------->
             <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-file-earmark-ppt" viewBox="0 0 16 16">
          ...
          {{$doc->nom}}</td>
          <td style="text-align: left;border:0px;">{{$doc->type}}</td>
          <td style="text-align: left;border:0px;">{{$doc->taille}} ko</td>
          <td style="border:0px;">
        ...
        <button type="button" title="demander l'accès \n demander" class="btn btn-warning demande" name="{{$doc->id}}_{{Auth::user()->id}}" >
       ...
       @endif
        ...
        @elseif(isset($documents)) <!--------------------- Aucun documents------------------------->
         
      
        
      
        <div class="container d-flex justify-content-center w3-animate-left" >
          <div >
              <div class="card-header pt-3 pb-0 ml-auto border-0 " style="background-color:#ffffff">
                  <svg  class=" cursor-pointer" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 172 172" style=" fill:#ffffff;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M33.73372,23.59961l-10.13411,10.13411l52.26628,52.26628l-52.26628,52.26628l10.13411,10.13411l52.26628,-52.26628l52.26628,52.26628l10.13411,-10.13411l-52.26628,-52.26628l52.26628,-52.26628l-10.13411,-10.13411l-52.26628,52.26628z"></path></g></g></svg>
              </div>
                  ...
                  <div class="row no-gutters  mx-auto justify-content-start flex-sm-row flex-column">
                      ...
                      <div class="col-md-6 ">
                          <div class="card border-0 ">
                              <div class="card-body">
                                  <h5 class="card-title "><b>Aucun Document.</b></h5>
                                  <p class="card-text "><p>Aucun Document dans <strong>{{$section->nom}}</strong>.</p></p>
                                  <button type="button" class="btn btn-dark btn-round-lg btn-lg" style="background-color: #002222" data-toggle="modal" data-target="#uploaderDocument" title="Uploader un document">  
   ...
   @endisset
   @elseif(isset($documentsInFolder))
   <!--------------------- Aucun documents------------------------->
