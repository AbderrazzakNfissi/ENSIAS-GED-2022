  ...
  <div class="card-body search-list">
    <table class="table">
                    ...
                    <div class="col-md-6 ">
                        <div class="card border-0 ">
                            <div class="card-body">
                                ...
                                <p class="card-text "><p>{{ $user->nom }} n'a partagé aucun Document.</p></p>
      ...
      <thead style="border-top : 0px ">
        <tr>
          <th scope="col" style="text-align: left;border :0px;border-left:1px solid rgb(184, 180, 180)">Nom</th>
          <th scope="col" style="text-align: left;border :0px;border-left:1px solid rgb(184, 180, 180)">Date</th>
          <th scope="col" style="text-align: left;border :0px;border-left:1px solid rgb(184, 180, 180)">Taille</th>
          <th scope="col" style="border :0px;border-left:1px solid rgb(184, 180, 180)">action</th>
        </tr>
      </thead>
      <tbody>
      @endif
