                    ...
                    <div class="card-body p-md-5 text-black">
                     ...
                     <form method="POST" action="{{ route('register') }}">
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                            <input type="text" id="form3Example1m" name="nom" autocomplete="off" class="form-control form-control-lg" :value="old('nom')" required autofocus />
                        ...
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                            <input type="text" autocomplete="off" id="form3Example1n" name="telephone" class="form-control form-control-lg" />
                      ...
                      <div class="form-outline mb-4">
                        <input type="email" autocomplete="off" name="email" id="form3Example8" class="form-control form-control-lg" :value="old('email')" required />
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                            <input type="password" autocomplete="off" name="password_confirmation" required  id="form3Example1n" class="form-control form-control-lg" />
